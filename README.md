...
1. Once, register the upstream repository in your local copy: `git remote add -f upstream git@github.com:snakemake-workflows/swgs-gistic.git` or `git remote add -f upstream https://github.com/snakemake-workflows/swgs-gistic.git` if you do not have setup ssh keys.
